// Country dial codes for the phone sign-in dropdown (mirrors the web app).
// `dial` has no leading "+"; `max` caps the national number length.
export type Country = {
  iso: string
  name: string
  dial: string
...
export function formatPhone(digits: string, dial: string) {
